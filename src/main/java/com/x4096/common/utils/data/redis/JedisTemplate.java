package com.x4096.common.utils.data.redis;
...
public class JedisTemplate {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(stringRedisTemplate.opsForValue().get("he"));

        stringRedisTemplate.opsForValue().set("hhh", "gggg");
        System.out.println(stringRedisTemplate.opsForValue().get("hhh"));
